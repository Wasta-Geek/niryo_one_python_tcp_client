...
class PacketBuilder:
    ...
    def __init__(self):
        self.__command_elements_dict = {
            ...
            Command.GET_SAVED_POSITION_LIST: self.__CommandElement("GET_SAVED_POSITION_LIST", self.__get_saved_position_list),
            Command.WAIT: self.__CommandElement("WAIT", self.__wait),
    ...
    def __calibrate(self, parameter_list):
        ...
        parameter_string_list = [parameter_list[0].name]
    ...
    def __set_arm_max_velocity(self, parameter_list):
        ...
        if not isinstance(percentage, int) or percentage not in range(0, 100):
    ...
    def __get_saved_position_list(self):
        return self.__build_packet_without_parameter(Command.GET_SAVED_POSITION_LIST)

    def __wait(self, parameter_list):
        return self.__build_packet_with_parameter(Command.WAIT, parameter_list)
